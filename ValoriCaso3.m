...
%DI SODDISFARE IL CASO: due autovalori reali e distinti.
fprintf("CASO: 2 autovalori reali e distinti\n");
...
fprintf("------------------------------------------------------------\n");
fprintf("progettazione dell'osservatore asintotico dello stato in cui\nsi impone una dinamica di errore con convergenza relativamente lenta\n");
fprintf("------------------------------------------------------------\n");
